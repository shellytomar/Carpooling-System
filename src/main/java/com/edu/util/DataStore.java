...
public class DataStore {
	...
	private static ArrayList<String> weekdays = new ArrayList<String>(Arrays.asList("Monday", "Tuesday", "Wednesday", "Thursday"));
	...
	private static void initializeVehicles() {
		for (Driver driver : driverList) {
			...
			vehicleList.add(new Sedan(220, "Black", "Sedan", "Accord0", "CA9876", driverName, "hasFreeSpace", "regular"));
			vehicleList.add(new XUV(230, "Maroon", "XUV", "Honda0", "CA6576", driverName, "hasFreeSpace", "regular"));
			vehicleList.add(new Sedan(250, "Blue", "Sedan", "Accord0", "CA7776", driverName, "hasFreeSpace", "compact"));
		}
	}
	...
	private static void initializePassengers() {
		try {
			String line = null;
			String fileName = "C:/Users/shell/workspace/CarpoolingSystem/src/main/resources/passenger.txt";
	...
	private static void intializeDrivers() {
		try {
			String line = null;
			String fileName = "C:/Users/shell/workspace/CarpoolingSystem/src/main/resources/driver.txt";
			FileReader fileReader = new FileReader(fileName);
			BufferedReader bufferedReader = new BufferedReader(fileReader);
			while ((line = bufferedReader.readLine()) != null) {
