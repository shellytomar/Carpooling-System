...
public class Dispatcher {
	...
	public void dispatchRide(List<Request> requestList) throws Exception {
		Passenger passenger = DataStore.getPassengerByName("Robert");
						...
						if (inputParking.equalsIgnoreCase("Y")) {
							...
							case 1:
								if (newVehicleForRide.getVehicleSize().equalsIgnoreCase("regular")) {
									...
									p1.showParkingDetails(garage.getGarageLoc(), "", request.getRequestDate(),fromTime,toTime, garage.getParkingCost());
								     } 
	...
	public static void addRideToFile(int requestId, String pickUp, String dest, String date, float time,
		...
		File file = new File("C:/Users/shell/workspace/CarpoolingSystem/src/main/resources/ride.txt");
	...
	private static void printVehicleDetails(Vehicle vehicle) {
		...
		System.out.println("Model: " + vehicle.getVehicleType());
		System.out.println("==================================================");
		System.out.println("");
	}
